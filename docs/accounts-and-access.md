...
| Cloud staging | Not provisioned | Run `./scripts/setup-cloud-staging.sh`             |
| Production    | Not provisioned | Auto-deploy on push to `main` (once Vercel linked) |
...
- Local staging uses separate Docker containers (ports 5433, 6380) — isolated from dev data
